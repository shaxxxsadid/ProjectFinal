            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="space-y-3 pt-2">
                        {[
                            { label: 'Business ID', value: activeBusinessProfile._id.toString() },
                            { label: 'Business Name', value: activeBusinessProfile.legalName || 'Unknown' },
                            { label: 'Type', value: activeBusinessProfile?.type || 'Unknown' },
                            { label: 'Tax ID', value: activeBusinessProfile?.taxId || 'Unknown' },
                            { label: 'Created At', value: new Date(activeBusinessProfile.createdAt).toLocaleString() },
                            { label: 'Updated At', value: new Date(activeBusinessProfile.updatedAt).toLocaleString() },
                        ].map(({ label, value }) => (
